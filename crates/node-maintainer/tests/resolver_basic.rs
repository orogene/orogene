// TODO: Temporarily disabled. Re-enable when we figure out how to test the
// currently non-deterministic resolver.
...
//                 deps[dep.name().to_string()] =
//                     json!(dep.get(0).unwrap().as_string().unwrap());
//             }
//             deps
//         });
