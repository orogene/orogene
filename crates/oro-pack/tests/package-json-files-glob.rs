...
#[test]
fn pkg_json_files_glob() -> std::io::Result<()> {
    ...
    fs::create_dir_all(dir_path.join("ignored")).unwrap();

    let _a = File::create(dir_path.join("src/module.js"))?;
    let _a = File::create(dir_path.join("src/add.js"))?;
    let _a = File::create(dir_path.join("ignored/module.js"))?;
