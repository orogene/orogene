...
fn git_shorthand<'a, E>(input: &'a str) -> IResult<&'a str, GitInfo, E>
where
    E: ParseError<&'a str>,
{
...
fn committish<'a, E>(input: &'a str) -> IResult<&'a str, (Option<String>, Option<VersionReq>), E>
where
    E: ParseError<&'a str>,
{
...
fn git_url<'a, E>(input: &'a str) -> IResult<&'a str, GitInfo, E>
where
    E: ParseError<&'a str>,
{
...
fn git_scp<'a, E>(input: &'a str) -> IResult<&'a str, GitInfo, E>
where
    E: ParseError<&'a str>,
{
