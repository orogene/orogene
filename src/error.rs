...
pub enum OroError {
    ...
    #[error(
        "{0} is not a valid package name. Only package names should be passed to `oro remove`, but you passed either a non-NPM package specifier or an invalid package name."
    )]
    #[diagnostic(
